...
ClassifyModule = __decorate([
    (0, common_1.Module)({
        imports: [classifyDB_module_1.ClassifyDBModule],
        controllers: [classify_controller_1.default],
        providers: [classify_service_1.default],
        exports: [classify_service_1.default]
    })
], ClassifyModule);
